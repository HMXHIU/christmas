...
export class RedeemCoupon extends LitElement {
        ...
        return html`
            ...
            <sl-input type="text" value="${this.redemptionQRCodeURL}" disabled>
                <sl-icon-button
                    ...
                    slot="suffix"
                    @click=${() =>
                        this.copyToClipboard(this.redemptionQRCodeURL)}
                ></sl-icon-button>
            </sl-input>
        `;
    }
    ...
    getRedeem() {
        return html`
            ...
            <p>
                This coupon will be only be valid for 15mins. Make sure you are
                at the location before redeeming.
            </p>
    ...
    render() {
        return html`
            ...
            <sl-dialog
                ...
                id="dialog"
            >
                ${this.redemptionQRCodeURL
                    ? this.getAlreadyRedeem()
                    : this.getRedeem()}
            </sl-dialog>
        `;
    }
